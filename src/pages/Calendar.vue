<template>
    <div class="m-auto">
        ...
        <section class="flex flex-wrap">
            <p1 class='text-center' style="width:14.28%" v-for="num in startDay()" :key="num">
            </p1>
            <p1 class='text-center' style="width:14.28%" v-for="num in daysInMonth()" :key="num" :class="currentDateClass(num)">
                {{num}}
            </p1>
        </section>
